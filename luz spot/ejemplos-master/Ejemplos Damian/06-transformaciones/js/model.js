class Model {
	...
	generateModel(pos_location, normal_location) {
		...
		let normalsSolid = parsedOBJ.normals;
		let normalsWire = Utils.reArrangeIndicesToRenderWithLines(parsedOBJ.normals);
		this.indexNormalsCountSolid = normalsSolid.length;
		this.indexNormalsCountWire = normalsWire.length;
